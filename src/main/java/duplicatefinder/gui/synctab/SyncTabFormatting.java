...
final class SyncTabFormatting {
    ...
    static JPanel buildLegend() {
        JPanel legend = duplicatefinder.gui.Ui.panel(new FlowLayout(FlowLayout.RIGHT, 10, 4));
    ...
    private static JPanel legendDot(Color c, String label) {
        JPanel p = duplicatefinder.gui.Ui.panel(new FlowLayout(FlowLayout.LEFT, 4, 0));
        ...
        p.add(duplicatefinder.gui.Ui.label(label, FONT_SMALL, MUTED));
        return p;
    }
}
