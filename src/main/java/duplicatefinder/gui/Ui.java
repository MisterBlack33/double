...
/** Öffentliche Factory-Klasse für konsistente UI-Komponenten, paketübergreifend nutzbar. */
public final class Ui {
    ...
    public static JButton button(String text, Color bg, Color fg, int w, int h) {
