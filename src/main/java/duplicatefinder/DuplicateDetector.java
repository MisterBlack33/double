...
public class DuplicateDetector {
     ...
     *
     * @param files            alle zu prüfenden Dateien
     * @param progressCallback optional: (verarbeitet, gesamt) → void; darf null sein
     * @return {@link ScanResult} mit allen Gruppen und Statistiken
     * @throws IOException bei schwerwiegenden Lesefehlern
     */
    ...
    /** Bequemlichkeitsmethode ohne Fortschritts-Callback. */
    ...
    /**
     * Berechnet einen SHA-256-Hash der Datei.
     *
     * @param quick wenn true, werden nur die ersten {@value #QUICK_BYTES} Bytes gelesen
     */
